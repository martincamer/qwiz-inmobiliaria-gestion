...
const NuevoPagoChequesSheet = ({ isOpen, onClose, clienteId, onSuccess }) => {
  const { registrarPagoCheque, isLoading } = useCliente();
  ...
  return (
    <Sheet open={isOpen} onOpenChange={handleClose}>
      <SheetContent className="min-w-4xl overflow-y-auto p-4">
        <SheetHeader>
          ...
          <SheetDescription>
            Registra un nuevo cheque emitido o recibido
          </SheetDescription>
        </SheetHeader>
        ...
        <SheetFooter className="gap-2">
          ...
          <Button onClick={handleSubmit} disabled={isLoading}>
            {isLoading ? "Guardando..." : "Guardar Cheque"}
          </Button>
        </SheetFooter>
      </SheetContent>
    </Sheet>
...
export default NuevoPagoChequesSheet;
