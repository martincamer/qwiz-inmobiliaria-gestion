...
const EditProspectModal = ({ open, onOpenChange, prospect, onSuccess }) => {
  ...
  // Cargar datos del prospecto cuando se abre el modal
  useEffect(() => {
    if (open && prospect) {
      setEditedProspect({
        ...
        telefonoSecundario: prospect.telefonoSecundario || "",
        fechaNacimiento: prospect.fechaNacimiento ? 
          new Date(prospect.fechaNacimiento).toISOString().split('T')[0] : "",
        direccion: prospect.direccion || "",
        ciudad: prospect.ciudad || "",
        provincia: prospect.provincia || "",
        codigoPostal: prospect.codigoPostal || "",
        tipoCliente: prospect.tipoCliente || "Comprador",
        tipoPropiedad: prospect.tipoPropiedad || "",
        ubicacionPreferida: prospect.ubicacionPreferida || "",
        presupuestoMin: prospect.presupuestoMin || "",
        presupuestoMax: prospect.presupuestoMax || "",
        habitaciones: prospect.habitaciones || "",
        baños: prospect.baños || "",
        caracteristicasEspeciales: prospect.caracteristicasEspeciales || "",
        estado: prospect.estado || "Nuevo",
        origen: prospect.origen || "",
        prioridad: prospect.prioridad || "Media",
        notas: prospect.notas || "",
        agenteAsignado: prospect.agenteAsignado?._id || prospect.agenteAsignado || "",
      });
      setErrors({});
    }
  }, [open, prospect]);
  ...
  const validateForm = () => {
    ...
    if (!editedProspect.nombre.trim()) {
      newErrors.nombre = "El nombre es requerido";
    }

    if (!editedProspect.apellido.trim()) {
      newErrors.apellido = "El apellido es requerido";
    }

    if (!editedProspect.email.trim()) {
      newErrors.email = "El email es requerido";
    } else if (!/\S+@\S+\.\S+/.test(editedProspect.email)) {
      newErrors.email = "El email no es válido";
    }

    if (!editedProspect.telefono.trim()) {
      newErrors.telefono = "El teléfono es requerido";
    }

    if (!editedProspect.origen.trim()) {
      newErrors.origen = "El origen es requerido";
    }

    // Validaciones de presupuesto
    if (editedProspect.presupuestoMin && editedProspect.presupuestoMax) {
      const min = parseFloat(editedProspect.presupuestoMin);
      const max = parseFloat(editedProspect.presupuestoMax);
      if (min > max) {
    ...
    if (editedProspect.habitaciones && isNaN(editedProspect.habitaciones)) {
      newErrors.habitaciones = "Debe ser un número válido";
    }

    if (editedProspect.baños && isNaN(editedProspect.baños)) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const prospectData = {
        ...editedProspect,
        presupuestoMin: editedProspect.presupuestoMin ? parseFloat(editedProspect.presupuestoMin) : undefined,
        presupuestoMax: editedProspect.presupuestoMax ? parseFloat(editedProspect.presupuestoMax) : undefined,
        habitaciones: editedProspect.habitaciones ? parseInt(editedProspect.habitaciones) : undefined,
        baños: editedProspect.baños ? parseInt(editedProspect.baños) : undefined,
      };
      ...
      const result = await updateProspect(prospect._id, prospectData);
      
      if (result.success) {
        toast.success("Prospecto actualizado exitosamente");
        onSuccess();
      } else {
        toast.error(result.error || "Error al actualizar prospecto");
      }
    } catch (error) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Modifica la información del prospecto. Los campos marcados con * son obligatorios.
          </DialogDescription>
        </DialogHeader>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="fechaNacimiento"
                        type="date"
                        value={editedProspect.fechaNacimiento}
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={editedProspect.tipoCliente}
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={editedProspect.telefonoSecundario}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="direccion"
                      value={editedProspect.direccion}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="provincia"
                        value={editedProspect.provincia}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="codigoPostal"
                        value={editedProspect.codigoPostal}
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        value={editedProspect.tipoPropiedad}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        value={editedProspect.ubicacionPreferida}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        id="presupuestoMin"
                        type="number"
                        value={editedProspect.presupuestoMin}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="presupuestoMax"
                        type="number"
                        value={editedProspect.presupuestoMax}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        id="habitaciones"
                        type="number"
                        value={editedProspect.habitaciones}
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      value={editedProspect.caracteristicasEspeciales}
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={editedProspect.prioridad}
