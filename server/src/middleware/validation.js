...
export const validateCustomer = [
  ...
  body("address.city").trim().notEmpty().withMessage("La ciudad es requerida"),

  body("address.state").trim().notEmpty().withMessage("El estado es requerido"),
...
export const validarInquilino = [
  ...
  body("contactoEmergencia.relationship")
    ...
    .isLength({ max: 50 })
    .withMessage(
      "La relación del contacto de emergencia no puede exceder 50 caracteres"
    ),
...
export const validarPropiedad = [
  ...
  body("caracteristicas.superficie.descubierta")
    ...
    .custom((value) => value >= 0)
    .withMessage(
      "La superficie descubierta debe ser un número positivo o cero"
    ),
...
export const validarVenta = [
    ...
    .custom((value) => {
      if (value) {
        ...
        if (closingDate <= today) {
          throw new Error(
            "La fecha esperada de cierre debe ser posterior a hoy"
          );
        }
      }
      return true;
  ...
  body("additionalInfo.financingRequired")
    ...
    .isBoolean()
    .withMessage(
      "El campo financiamiento requerido debe ser verdadero o falso"
    ),
...
export const validarEstadoVenta = [
  ...
  body("reason")
    ...
    .isLength({ max: 500 })
    .withMessage(
      "La razón del cambio de estado no puede exceder 500 caracteres"
    ),
];

export const validarInteraccion = [
  body("type")
    .isIn(["llamada", "email", "whatsapp", "reunion", "visita", "otro"])
  ...
  body("outcome")
    ...
    .withMessage("Resultado de interacción inválido"),

  body("nextAction")
    .optional()
    .trim()
    .isLength({ max: 500 })
    .withMessage("La próxima acción no puede exceder 500 caracteres"),
...
export const validarPropiedadMostrada = [
  body("propertyId")
    .isMongoId()
    .withMessage("El ID de la propiedad debe ser válido"),

  body("showingDate")
    .isISO8601()
    .withMessage("La fecha de muestra debe ser una fecha válida"),

  body("feedback")
    .optional()
    .trim()
    .isLength({ max: 1000 })
    .withMessage("El feedback no puede exceder 1000 caracteres"),

  body("interested")
    .optional()
    .isBoolean()
    .withMessage("El campo interesado debe ser verdadero o falso"),
